...
int servo1Pin = 2;       /* Servo1 servo */
int servo2Pin = 3;   /* Servo2 servo */
int servo3Pin = 4;       /* Servo3 servo */
int servo4Pin = 5;     /* Servo4 servo */

int xdirPin = A1;        /* Servo1 - joystick1*/
int ydirPin = A2;        /* Servo2 - joystick1 */
int zdirPin = A4;        /* Servo3 - joystick2 */
int gdirPin = A5;        /* Servo4 - joystick2 */

//int pinRecord = A4;     /* Button record - backward compatibility */
//int pinPlay = A5;       /* Button play  - backward compatibility */
int pinRecord = A0;     /* Button record - recommended (A4 is deprecated, will by used for additional joystick) */
int pinPlay = A3;       /* Button play  - recommended (A5 is deprecated, will by used for additional joystick) */
